...
class App:
    ...
    def main():
        ...
        new_sample_rate = AudioCalculator.calc_shifted_sample_rate(sample_rate, shift_width)
        AudioWriter.write(output_file_name, audio_data, new_sample_rate, subtype=AudioFormatConfig.OUTPUT_SUBTYPE)
    ...
    def __parse_args() -> tuple[str, str, int]:
        ...
        output_file_name = re.sub(r'([^.]+).wav', r'\1{}.wav'.format(App.__OUTPUT_FILE_SUFFIX), input_file_name)
